...
public class HttpClientUtils {
     ...
     * @throws Exception
     */
    public static HttpClientResult doPost(String url, List<NameValuePair>  headers, Map<String, String> params) throws Exception {
        // 创建httpClient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
     ...
     * @param httpMethod
     */
    public static void packageHeader( List<NameValuePair>  headers, HttpRequestBase httpMethod) {
        // 封装请求头
        if (headers != null) {
